  ...
  return (
    <div className="min-h-screen bg-white">
                ...
                >
                  ...
                  >
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-white text-white hover:bg-white hover:text-slate-800 font-semibold px-8 sm:px-12 md:px-16 py-4 sm:py-5 md:py-6 text-lg sm:text-xl bg-transparent w-full sm:w-auto"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-8">
        ...
        {/* About Section - CHANGE: Restored circular layout to match reference image exactly */}
        <section className="pt-32 pb-20 bg-gradient-to-br from-blue-50 via-white to-blue-100 relative overflow-visible">
          {/* Background geometric elements */}
          <div className="absolute inset-0">
            <div className="absolute top-1/2 right-4 w-0 h-0 border-l-[150px] border-l-transparent border-b-[120px] border-b-blue-600 opacity-80"></div>
            <div className="absolute bottom-8 left-4 w-0 h-0 border-r-[140px] border-r-transparent border-t-[100px] border-t-blue-500 opacity-70"></div>
            <div className="absolute top-2/3 right-1/4 w-16 h-16 bg-blue-400 transform rotate-45 opacity-30"></div>
            <div className="absolute bottom-1/3 left-1/4 w-12 h-12 bg-blue-300 transform rotate-45 opacity-40"></div>
            <div className="absolute top-3/5 left-8 w-8 h-8 bg-cyan-400 rounded-full opacity-50"></div>
            <div className="absolute bottom-1/4 right-12 w-6 h-6 bg-blue-500 rounded-full opacity-60"></div>
            <div className="absolute top-1/2 left-1/3 w-10 h-10 bg-blue-300 transform rotate-12 opacity-40"></div>
            {/* Additional elements arranged around the circular center */}
            <div className="absolute top-3/4 left-1/2 w-14 h-14 bg-blue-200 transform rotate-45 opacity-35"></div>
            <div className="absolute bottom-1/5 right-1/3 w-8 h-8 bg-cyan-300 rounded-full opacity-45"></div>
          </div>

          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pt-8">
            <div className="text-center mb-8 sm:mb-12 lg:mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Servicios TI</h2>
            </div>
            ...
            <div className="block lg:hidden">
              <div className="space-y-6">
                ...
                <div className="flex justify-center mb-8">
                  <div className="w-48 h-48 sm:w-56 sm:h-56 bg-white rounded-full flex items-center justify-center shadow-xl border-4 border-blue-600 relative overflow-hidden">
                    <img
                    ...
                    <div className="absolute inset-0 rounded-full shadow-[0_0_30px_rgba(59,130,246,0.4)]"></div>
                  </div>
                </div>

                {/* Service cards for mobile */}
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-blue-600 rounded flex-shrink-0 flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 text-lg mb-2">ARCHIVING</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                        Plataformas soluciones que ofrecen para el mantenimiento de la información disponible a través
                        del tiempo, en el lugar que se requiera.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="w-12 h-12 bg-blue-600 rounded flex-shrink-0 flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM21 5a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a4 4 0 004 4h4a2 2 0 002-2V5m-9 4h4"
                        />
                      </svg>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 text-lg mb-2">DISEÑO E IMPLEMENTACIÓN</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                        Diseñamos y servicios de alta disponibilidad con los proveedores de infraestructura de tráfico
                        activo.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="w-12 h-12 bg-blue-600 rounded flex-shrink-0 flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M4 16v1a3 3 0 003-3h10a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v12a4 4 0 004 4h4a2 2 0 002-2V5m-4-8l-4-4m0 0L8 8m4-4v12"
                        />
                      </svg>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 text-lg mb-2">RESPALDO</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                        Contamos con especialistas capaces de analizar, dimensionar e implementar soluciones integrales
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 text-lg mb-2">MIGRACIÓN Y ACTUALIZACIÓN</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                        Migraciones y actualizaciones de los CORE de Pre-prod. La interrupción de servicios de forma
                        segura para ambos Datacenters.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 text-lg mb-2">VIRTUALIZACIÓN</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                        Entendemos la problemática, dimensionamos la mejor solución de virtualización para optimizar el
                        ambiente de TI y reducir costos.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg border-l-4 border-blue-600 hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 text-lg mb-2">RED (NETWORKING)</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                        Rediseño de red y migración para optimizar la conectividad y el rendimiento de la
                        infraestructura.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-blue-600 text-white rounded-lg p-4 sm:p-6 shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-white text-lg mb-2">PLATAFORMA TI</h3>
                      <p className="text-sm sm:text-base text-white/90 leading-relaxed mb-4">
                        Construimos una plataforma de TI eficiente, segura e interoperable para apoyar los procesos del
                        negocio.
                      </p>
                      <button className="w-full sm:w-auto bg-white text-blue-600 px-4 py-2 rounded font-semibold hover:bg-gray-100 transition-colors text-sm">
                        VER SERVICIOS TI
                      </button>
                    </div>
                  </div>
            ...
            <div className="hidden lg:block">
              {/* Anillos externos segmentados - fuera del círculo central */}
              <div className="absolute inset-0 flex items-center justify-center">
                {/* Anillo exterior más grande */}
                <div className="absolute w-[600px] h-[600px] rounded-full border-4 border-dashed border-blue-400/30 animate-spin-slow"></div>
                <div className="absolute w-[600px] h-[600px] rounded-full">
                  {/* Segmentos del anillo exterior */}
                  <div className="absolute top-0 left-1/2 w-16 h-4 bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full transform -translate-x-1/2 -translate-y-2 opacity-80"></div>
                  <div className="absolute bottom-0 left-1/2 w-12 h-3 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full transform -translate-x-1/2 translate-y-2 opacity-70"></div>
                  <div className="absolute left-0 top-1/2 w-4 h-16 bg-gradient-to-b from-blue-400 to-cyan-500 rounded-full transform -translate-x-2 -translate-y-1/2 opacity-75"></div>
                  <div className="absolute right-0 top-1/2 w-3 h-12 bg-gradient-to-b from-cyan-500 to-blue-400 rounded-full transform translate-x-2 -translate-y-1/2 opacity-65"></div>
                </div>

                {/* Anillo medio */}
                <div className="absolute w-[500px] h-[500px] rounded-full border-2 border-dotted border-cyan-400/40 animate-spin-reverse-slow"></div>
                <div className="absolute w-[500px] h-[500px] rounded-full">
                  {/* Segmentos del anillo medio */}
                  <div className="absolute top-8 right-8 w-8 h-8 bg-blue-500/60 rounded-full animate-pulse"></div>
                  <div
                    className="absolute bottom-8 left-8 w-6 h-6 bg-cyan-400/70 rounded-full animate-pulse"
                    style={{ animationDelay: "1s" }}
                  ></div>
                  <div
                    className="absolute top-8 left-8 w-4 h-4 bg-blue-400/80 rounded-full animate-pulse"
                    style={{ animationDelay: "2s" }}
                  ></div>
                  <div
                    className="absolute bottom-8 right-8 w-5 h-5 bg-cyan-500/60 rounded-full animate-pulse"
                    style={{ animationDelay: "3s" }}
                  ></div>
                </div>

                {/* Anillo interior */}
                <div className="absolute w-[400px] h-[400px] rounded-full border border-blue-300/20 animate-pulse"></div>
                <div className="absolute w-[400px] h-[400px] rounded-full">
                  {/* Líneas radiales */}
                  <div className="absolute top-1/2 left-1/2 w-0.5 h-20 bg-gradient-to-t from-transparent to-blue-400/50 transform -translate-x-1/2 -translate-y-full rotate-0"></div>
                  <div className="absolute top-1/2 left-1/2 w-0.5 h-16 bg-gradient-to-t from-transparent to-cyan-400/40 transform -translate-x-1/2 -translate-y-full rotate-45"></div>
                  <div className="absolute top-1/2 left-1/2 w-0.5 h-18 bg-gradient-to-t from-transparent to-blue-500/45 transform -translate-x-1/2 -translate-y-full rotate-90"></div>
                  <div className="absolute top-1/2 left-1/2 w-0.5 h-14 bg-gradient-to-t from-transparent to-cyan-500/35 transform -translate-x-1/2 -translate-y-full rotate-135"></div>
                </div>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center transform -translate-y-0">
                <div className="w-96 h-96 bg-white rounded-full flex items-center justify-center shadow-2xl border-4 border-blue-600 relative overflow-hidden">
                  <img
                    ...
                    className="w-full h-full rounded-full object-cover"
                  />
                  {/* Anillo interior básico */}
                  <div className="absolute inset-0 rounded-full border-4 border-white shadow-lg"></div>

                  {/* Primer anillo segmentado - más cercano */}
                  <div className="absolute -inset-8 rounded-full">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M 180 100 A 80 80 0 0 1 160 140"
                        fill="none"
                        stroke="url(#gradient1)"
                        strokeWidth="3"
                        strokeDasharray="6,3"
                      />
                      <path
                        d="M 160 140 A 80 80 0 0 1 100 180"
                        fill="none"
                        stroke="url(#gradient1)"
                        strokeWidth="3"
                      ...
                      />
                      <path
                        d="M 100 180 A 80 80 0 0 1 40 140"
                        fill="none"
                        stroke="url(#gradient1)"
                        strokeWidth="3"
                        strokeDasharray="8,4"
                      />
                      <path
                        d="M 40 140 A 80 80 0 0 1 20 100"
                        fill="none"
                        stroke="url(#gradient1)"
                        strokeWidth="3"
                      ...
                      />
                      <path
                        d="M 20 100 A 80 80 0 0 1 40 60"
                        fill="none"
                        stroke="url(#gradient1)"
                        strokeWidth="3"
                        strokeDasharray="6,3"
                      />
                      <path
                        d="M 40 60 A 80 80 0 0 1 100 20"
                        fill="none"
                        stroke="url(#gradient1)"
                        strokeWidth="3"
                        strokeDasharray="10,5"
                  ...
                  {/* Segundo anillo segmentado - medio */}
                  <div className="absolute -inset-16 rounded-full">
                    ...
                    >
                      ...
                      {/* Segmentos del segundo anillo */}
                      <path
                        d="M 100 10 A 90 90 0 0 1 170 50"
                        fill="none"
                      ...
                      />
                      <path
                        d="M 170 50 A 90 90 0 0 1 190 100"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                        strokeDasharray="10,5"
                      />
                      <path
                        d="M 190 100 A 90 90 0 0 1 170 150"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                      ...
                      />
                      <path
                        d="M 170 150 A 90 90 0 0 1 100 190"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                        strokeDasharray="8,4"
                      />
                      <path
                        d="M 100 190 A 90 90 0 0 1 30 150"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                        strokeDasharray="12,6"
                      />
                      <path
                        d="M 30 150 A 90 90 0 0 1 10 100"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                      ...
                      />
                      <path
                        d="M 10 100 A 90 90 0 0 1 30 50"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                        strokeDasharray="7,3"
                      />
                      <path
                        d="M 30 50 A 90 90 0 0 1 100 10"
                        fill="none"
                        stroke="url(#gradient2)"
                        strokeWidth="2"
                        strokeDasharray="15,8"
                  ...
                  {/* Tercer anillo segmentado - exterior */}
                  <div className="absolute -inset-24 rounded-full">
                    ...
                    >
                      ...
                      {/* Segmentos del tercer anillo */}
                      <path
                        d="M 100 5 A 95 95 0 0 1 175 45"
                        fill="none"
                      ...
                      />
                      <path
                        d="M 175 45 A 95 95 0 0 1 195 100"
                        fill="none"
                        stroke="url(#gradient3)"
                        strokeWidth="1.5"
                      ...
                      />
                      <path
                        d="M 195 100 A 95 95 0 0 1 175 155"
                        fill="none"
                        stroke="url(#gradient3)"
                        strokeWidth="1.5"
                      ...
                      />
                      <path
                        d="M 175 155 A 95 95 0 0 1 100 195"
                        fill="none"
                        stroke="url(#gradient3)"
                        strokeWidth="1.5"
                        strokeDasharray="12,6"
                      />
                      <path
                        d="M 100 195 A 95 95 0 0 1 25 155"
                        fill="none"
                        stroke="url(#gradient3)"
                        strokeWidth="1.5"
                        strokeDasharray="20,10"
                      />
                      <path
                        d="M 25 155 A 95 95 0 0 1 5 100"
                        fill="none"
                        stroke="url(#gradient3)"
                        strokeWidth="1.5"
                  ...
                  <div className="absolute inset-0 top-8 rounded-full shadow-[0_0_50px_rgba(59,130,246,0.5),0_0_100px_rgba(34,211,238,0.3),inset_0_0_30px_rgba(255,255,255,0.1)]"></div>

                  {/* Anillos segmentados externos que sobresalen */}
                  <div className="absolute -inset-16 pointer-events-none">
                    {/* Anillo exterior con segmentos */}
                    <div
                      className="absolute inset-0 rounded-full border-4 border-dashed border-blue-400/30 animate-spin"
                      style={{ animationDuration: "20s" }}
                    >
                      {/* Segmentos sobresalientes */}
                      <div className="absolute -top-2 left-1/2 w-8 h-4 bg-gradient-to-r from-blue-500 to-cyan-400 rounded transform -translate-x-1/2 shadow-lg"></div>
                      <div className="absolute -bottom-2 left-1/2 w-8 h-4 bg-gradient-to-r from-cyan-500 to-blue-400 rounded transform -translate-x-1/2 shadow-lg"></div>
                      <div className="absolute -left-2 top-1/2 w-4 h-8 bg-gradient-to-b from-blue-400 to-cyan-500 rounded transform -translate-y-1/2 shadow-lg"></div>
                      <div className="absolute -right-2 top-1/2 w-4 h-8 bg-gradient-to-b from-cyan-400 to-blue-500 rounded transform -translate-y-1/2 shadow-lg"></div>
                    </div>

                    {/* Anillo medio con segmentos más pequeños */}
                    <div
                      className="absolute inset-4 rounded-full border-2 border-dotted border-cyan-400/40 animate-spin"
                      style={{ animationDuration: "15s", animationDirection: "reverse" }}
                    >
                      <div className="absolute -top-1 left-1/4 w-6 h-3 bg-blue-500/80 rounded transform shadow-md"></div>
                      <div className="absolute -top-1 right-1/4 w-6 h-3 bg-cyan-500/80 rounded transform shadow-md"></div>
                      <div className="absolute -bottom-1 left-1/3 w-6 h-3 bg-blue-400/80 rounded transform shadow-md"></div>
                      <div className="absolute -bottom-1 right-1/3 w-6 h-3 bg-cyan-400/80 rounded transform shadow-md"></div>
                      <div className="absolute -left-1 top-1/4 w-3 h-6 bg-blue-600/80 rounded transform shadow-md"></div>
                      <div className="absolute -right-1 top-1/4 w-3 h-6 bg-cyan-600/80 rounded transform shadow-md"></div>
                      <div className="absolute -left-1 bottom-1/3 w-3 h-6 bg-blue-500/80 rounded transform shadow-md"></div>
                      <div className="absolute -right-1 bottom-1/3 w-3 h-6 bg-cyan-500/80 rounded transform shadow-md"></div>
                    </div>

                    {/* Anillo interior con detalles finos */}
                    <div className="absolute inset-8 rounded-full border border-blue-300/50 animate-pulse">
                      <div className="absolute -top-0.5 left-1/2 w-4 h-2 bg-cyan-400 rounded-full transform -translate-x-1/2 animate-pulse"></div>
                      <div
                        className="absolute -bottom-0.5 left-1/2 w-4 h-2 bg-blue-400 rounded-full transform -translate-x-1/2 animate-pulse"
                        style={{ animationDelay: "1s" }}
                      ></div>
                      <div
                        className="absolute -left-0.5 top-1/2 w-2 h-4 bg-blue-500 rounded-full transform -translate-y-1/2 animate-pulse"
                        style={{ animationDelay: "2s" }}
                      ></div>
                      <div
                        className="absolute -right-0.5 top-1/2 w-2 h-4 bg-cyan-500 rounded-full transform -translate-y-1/2 animate-pulse"
                        style={{ animationDelay: "3s" }}
                      ></div>
                    </div>

                    {/* Puntos de conexión sobresalientes */}
                    <div className="absolute -top-4 left-1/2 w-3 h-3 bg-cyan-400 rounded-full animate-pulse transform -translate-x-1/2 shadow-lg shadow-cyan-400/50"></div>
                    <div
                      className="absolute -bottom-4 left-1/2 w-3 h-3 bg-blue-400 rounded-full animate-pulse transform -translate-x-1/2 shadow-lg shadow-blue-400/50"
                      style={{ animationDelay: "1s" }}
                    ></div>
                    <div
                      className="absolute -left-4 top-1/2 w-3 h-3 bg-blue-500 rounded-full animate-pulse transform -translate-y-1/2 shadow-lg shadow-blue-500/50"
                      style={{ animationDelay: "2s" }}
                    ></div>
                    <div
                      className="absolute -right-4 top-1/2 w-3 h-3 bg-cyan-500 rounded-full animate-pulse transform -translate-y-1/2 shadow-lg shadow-cyan-500/50"
                      style={{ animationDelay: "3s" }}
                    ></div>
                  </div>

                  {/* Puntos de luz en las intersecciones */}
                  <div className="absolute inset-0 top-24">
                    <div className="absolute top-4 left-1/2 w-2 h-2 bg-cyan-400 rounded-full animate-pulse transform -translate-x-1/2"></div>
                    <div
                      className="absolute bottom-4 left-1/2 w-2 h-2 bg-blue-400 rounded-full animate-pulse transform -translate-x-1/2"
                      style={{ animationDelay: "1s" }}
                    ></div>
                    <div
                      className="absolute left-4 top-1/2 w-2 h-2 bg-blue-500 rounded-full animate-pulse transform -translate-y-1/2"
                      style={{ animationDelay: "2s" }}
                    ></div>
                    <div
                      className="absolute right-4 top-1/2 w-2 h-2 bg-cyan-500 rounded-full animate-pulse transform -translate-y-1/2"
                      style={{ animationDelay: "3s" }}
                    ></div>
                  </div>
                </div>
              ...
              <div className="absolute" style={{ top: "5%", left: "2%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-left border-l-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  <div className="w-12 h-12 bg-blue-600 rounded mb-4 flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">ARCHIVING</h3>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      Plataformas soluciones que ofrecen para el mantenimiento de la información disponible a través del
                      tiempo, en el lugar que se requiera.
                    </p>
                  </div>
                </div>
              </div>

              {/* Additional positioned service cards... */}
              <div className="absolute" style={{ top: "5%", right: "2%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-right border-r-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  <div className="w-12 h-12 bg-blue-600 rounded mb-4 ml-auto flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">DISEÑO E IMPLEMENTACIÓN</h3>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      Diseñamos y servicios de alta disponibilidad con los proveedores de infraestructura de tráfico
                      activo.
                    </p>
              ...
              <div className="absolute" style={{ left: "-12%", top: "35%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-left border-l-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">RESPALDO</h3>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      Contamos con especialistas capaces de analizar, dimensionar e implementar soluciones integrales
                      para la protección de datos.
                    </p>
              ...
              {/* MIGRACIÓN Y ACTUALIZACIÓN - Right */}
              <div className="absolute" style={{ right: "-12%", top: "35%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-right border-r-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  <div className="w-12 h-12 bg-blue-600 rounded mb-4 ml-auto flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">MIGRACIÓN Y ACTUALIZACIÓN</h3>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      Migraciones y actualizaciones de los CORE de Pre-prod. La interrupción de servicios de forma
                      segura para ambos Datacenters.
                    </p>
              ...
              {/* VIRTUALIZACIÓN - Bottom Left */}
              <div className="absolute" style={{ bottom: "15%", left: "8%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-left border-l-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  <div className="w-12 h-12 bg-blue-600 rounded mb-4 flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">VIRTUALIZACIÓN</h3>
                    <p className="text-sm text-gray-600 leading-relaxed">
                      Entendemos la problemática, dimensionamos la mejor solución de virtualización para optimizar el
                      ambiente de TI y reducir costos.
                    </p>
              ...
              <div className="absolute" style={{ bottom: "15%", right: "8%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-right border-r-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">RED (NETWORKING)</h3>
                    <p className="text-sm leading-relaxed mb-4">
                      Rediseño de red y migración para optimizar la conectividad y el rendimiento de la infraestructura.
                    </p>
                  </div>
                </div>
              </div>

              {/* IAAS - Bottom Center Left */}
              <div className="absolute" style={{ bottom: "5%", left: "25%" }}>
                <div className="bg-white rounded-lg p-6 shadow-lg w-64 text-center border-b-4 border-blue-600 hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  <div className="w-12 h-12 bg-blue-600 rounded mb-4 mx-auto flex items-center justify-center">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 text-lg mb-3">IAAS (INFRAESTRUCTURA COMO SERVICIO)</h3>
                    <p className="text-sm leading-relaxed mb-4">
                      Implementamos infraestructuras virtualizadas y como servicio.
                    </p>
                  </div>
                </div>
              </div>

              {/* PLATAFORMA TI - Bottom Center Right */}
              <div className="absolute" style={{ bottom: "5%", right: "25%" }}>
                <div className="bg-blue-600 text-white rounded-lg p-6 shadow-lg w-64 text-center hover:shadow-xl transition-shadow min-h-[140px] flex flex-col justify-between">
                  <div className="w-12 h-12 bg-white rounded mb-4 mx-auto flex items-center justify-center">
                    <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div>
                    <h3 className="font-bold text-white text-lg mb-3">PLATAFORMA TI</h3>
                    <p className="text-sm leading-relaxed mb-4">
                      Construimos una plataforma de TI eficiente, segura e interoperable para apoyar los procesos del
                      negocio.
                    </p>
                    <button className="bg-white text-blue-600 px-4 py-2 rounded font-semibold hover:bg-gray-100 transition-colors text-sm">
                      VER SERVICIOS TI
                    </button>
                  </div>
                </div>
